...
* Create a roles directory to include scripts to be installed
  ...
  mkdir roles 
  ```
* Create a laravel directory  menginstall laravel framework
  ```
  mkdir laravel 
  ```
  
* Make 3 folders, with names tasks, handlers, dan templates
  ...
  - make file main.yml in the tasks, and include script like in the below
    ...
    - name: Write {{ domain }} to /etc/hosts
      lineinfile:
        ...
        state: present
    ```
  - make file main.yml in the handlers, and include script like in the below
    ```
    ---
    - name: restart php
      become: yes
    ...
    ```
   - make 3 files in the templates, and include script like in the below
     ```
     nano env.templates
     nano lv.conf
     nano php7.conf
     ...
     3. php7.conf
        ```
         ...
         ```
* Create folder php and make 2 tasks and handlers directory
    ```
    mkdir tasks
    mkdir handlers
    ```
    ![](asset/011.png)
    1. Include script like in the below `` nano main.yml `` in the tasks
    ```
    ---
    - name: delete apt chache
      become: yes
    ...
    - name: enable module php mbstring
      ...
      notify:
        - restart php
    ```
    2. Include script like in the below `nano main.yml` in the handlers
    ```
      ---
    - name: restart php
      become: yes
    ...
    - name: restart nginx
      ...
      action: service name=nginx state=restarted
    ```
* Create codeigniter directory `sudo mkdir codeigniter`

  - Then make 3 folders with names tasks, handlers, and templates
    ...
    - Make file main.yml in the tasks, and include script like in the below
     ...
     - Make file main.yml in the handlers, and include script like in the below
        ...
        ```
     - Make file app.conf in the templates, and include script like in the below
        ```
        server {
          listen 80;
          server_name {{ domain }};
        ...
        ```
* Create db directory `sudo mkdir db` 

  - Then make folders tasks, handlers, and templates 
    ```
    ...
    - Make file my.cnf in the templates, and include script like in the below 
      ...
      [mariadb]
      ```
* Create folders pma `sudo mkdir pma` and make directories tasks, handlers, dan templates.
    ```
 ...
 - At the tasks, make file main.yml and include script like in the below
  ...
  - At the handlers, make file main.yml and include script like in the below
  ...
  - At the templates, make file mpma.local and include script like in the below
    ...
    ```
* Create wordpress directories `sudo mkdir wordpress` and make 3 folders with names tasks, handlers, and templates
  ```
  ...
  - At handlers make file main.yml and include script like in the below
  ...
  - At templates, create 3 files
    ...
    3. wp.conf
       ...
       ```
* Create yii ndirectory `sudo mkdir yii`, and make 3 folders with name tasks, handlers, and templates
      ```
    ...
    - At templates make file yii.conf and include script like in the below
      ```
      server {
      ...
      ```
* After completing some steps above, now create file hosts `nano hosts` and include script like in the below
    ```
    [laravel]
    lxc_php7_2 ansible_host=lxc_php7_2.dev ansible_ssh_user=root ansible_become_pass=it0201
    lxc_php7_3 ansible_host=lxc_php7_3.dev ansible_ssh_user=root ansible_become_pass=it0201
    lxc_php7_4 ansible_host=lxc_php7_4.dev ansible_ssh_user=root ansible_become_pass=it0201
    lxc_php7_5 ansible_host=lxc_php7_5.dev ansible_ssh_user=root ansible_become_pass=it0201

    [codeigniter]
    lxc_php5_1 ansible_host=lxc_php5_1.dev ansible_ssh_user=root ansible_become_pass=it0201
    lxc_php5_2 ansible_host=lxc_php5_2.dev ansible_ssh_user=root ansible_become_pass=it0201

    [wordpress]
    lxc_php7_1 ansible_host=lxc_php7_1.dev ansible_ssh_user=root ansible_become_pass=it0201
    lxc_php7_2 ansible_host=lxc_php7_2.dev ansible_ssh_user=root ansible_become_pass=it0201
    lxc_php7_4 ansible_host=lxc_php7_4.dev ansible_ssh_user=root ansible_become_pass=it0201
    lxc_php7_6 ansible_host=lxc_php7_6.dev ansible_ssh_user=root ansible_become_pass=it0201
  ...
  - Make file install-codeigniter.yml `nano install-codeigniter.yml`, and include script like in the below 
    ...
    - hosts: lxc_php5_2
      ...
      roles:
        - app
    ```
  - make file install-laravel.yml `nano install-laravel.yml`, and include script like in the below 
    ```
    ---
    - hosts: laravel
      vars:
  ...
  - Make file install-mariadb.yml `nano install-mariadb.yml`, and include script like in the below 
    ```
    - hosts: database
      vars:
        username: 'kelompok1'
  ...
  - Make file bernama install-wordpress.yml `nano install-wordpress.yml` , and include script like in the below 
    ```
    ---
    - hosts: wordpress
      vars:
...
* to configure nginx, open `cd /etc/nginx/sites-available`.   Create a file with names kelompok1.fpsas, then enter `nanogroup3.fpsas`, and include script like in the below 
    ...
    server {
            ...
            server_name news.kelompok1.fpsas;
  ...
  - restart nginx
    ...
    ```
  - Check configuration web https://kelompok1.fpsas
